...
Here you can put a tikz picture \\
...
Now lets put a subsection\\

\subsection{Examples 2}

\lipsum[1-3]\\

I also crate a new kind of box, named "subbox"

\begin{subbox}{Name for the box}
    \lipsum[1]
\end{subbox}

You can choose any of the boxes and edit them in the config file "Boxes.tex"
